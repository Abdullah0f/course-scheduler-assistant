<template >
  <div class="mb-2 flex flex-column">
    <MultiSelect
      ...
      :showToggleAll="false" :pt="{checkboxContainer:'mr-0 ml-2',removeTokenIcon:'ml-0 mr-2'}"
      filter
      />
  </div>
</template>
...
watch(() => props.selectCourse, (newSelectCourse,oldSelectCourse) => {
