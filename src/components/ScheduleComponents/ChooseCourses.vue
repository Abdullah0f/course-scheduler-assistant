<template>
    <div class="my-5" >
        <MultiSelect class="w-full max-w-screen mb-2" v-model="selectedCourses" display="chip" :options="courses" optionLabel="name" optionValue="code"  placeholder="Select Courses"
