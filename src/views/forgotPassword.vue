<template>
    <div class="form-container">
        ...
        <Message v-if="showMessage" severity="success">إذا كان عنوان بريدك الإلكتروني مسجلاً لدينا،
            ستتلقى رسالة عبر البريد الإلكتروني لإعادة تعيين كلمة المرور</Message>
    </div>
</template>
